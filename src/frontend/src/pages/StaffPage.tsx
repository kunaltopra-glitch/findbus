...
export default function StaffPage() {
  ...
  // compute possible to-stops when fromStop changes
  ...
  // determine routeId whenever stops change
  useEffect(() => {
    if (fromStop && toStop) {
  ...
  const startTrip = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      (pos) => {
        // update backend with initial position (strap to zero index as demo)
